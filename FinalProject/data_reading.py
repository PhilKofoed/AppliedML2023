...
#%%
conn = db.connect(r'C:\Users\caspe\Desktop\AppliedML2023\FinalProject\database.sqlite')
c = conn.cursor()
...
df_x = pd.read_csv(r'C:\Users\caspe\Desktop\AppliedML2023\FinalProject\features_classification', index_col=0)
# %%
